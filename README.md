...
This implements training of popular model architectures from [timm](https://github.com/rwightman/pytorch-image-models), based on [official PyTorch example](https://github.com/pytorch/examples/tree/master/imagenet). Template code for my sons[Doge].

TODO:

- [ ] example of custom model in timm ways
...
optional arguments:
  ...
  --arch ARCH, -a ARCH  model architecture(default: resnet18)
